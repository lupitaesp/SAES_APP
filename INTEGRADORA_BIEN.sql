...
cual_deporte              varchar(20)    not null,
...
drogas                    varchar(2)         not null,
edad_inicio_d             varchar(2)        not null,
cuantas_veces_d           varchar(2)        not null,
...
secuelas_accidente       varchar(50)        not null,
fracturas                varchar(2)        not null,
complicaciones           varchar(2)        not null,
cual_complicacion        varchar(50)   		not null,
...
dias_de_duracion              varchar(30)       not null,
cada_cuantos_dias             varchar(30)       not null,
...
cual_metodo                   varchar(30)    not null,
